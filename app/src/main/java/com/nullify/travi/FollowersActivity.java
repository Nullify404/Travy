...
public class FollowersActivity extends AppCompatActivity implements NetworkStateReceiver.NetworkStateReceiverListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        networkStateReceiver.addListener(FollowersActivity.this);
        ...
        adapter = new ExploreSearchListAdapter(FollowersActivity.this, lemail, lname);
        ...
        travylist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(FollowersActivity.this,FollowProfileActivity.class);
    ...
    public class GetTravies extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... arg0) {
            ...
            try {
                ...
                URL url = new URL("http://www.nullify.in/travi/fetchfollowings.php");
