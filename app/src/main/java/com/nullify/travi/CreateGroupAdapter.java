...
/**
 * Created by abhishekpalodath on 05/07/2017.
 */

public class CreateGroupAdapter extends ArrayAdapter<String> {
    private ArrayList<String> email;
    private ArrayList<String> displayname;
    private Activity context;
    private StorageReference mstorage = FirebaseStorage.getInstance().getReference();

    public CreateGroupAdapter(Activity context, ArrayList<String> email, ArrayList<String> displayname) {
